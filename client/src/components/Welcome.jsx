            ...
            <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col md:mr-10">
                    ...
                    <p className="text-left mt-5 text-white font-light md:w-9/12 text-base">
                        Sell cryptocurrencies easily across the world. Explore the crypto world.
                    </p>
                    {!currentAccount && (
                    <button 
                        type="button" 
                    ...
                    <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
                        ...
                        <div className={'min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-sm font-light text-white rounded-tr-2xl'}>
                            Ethereum
                        </div>
                        <div className={'min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-sm font-light text-white rounded-bl-2xl'}>
                           Web 3.0
                        </div>
                        <div className={commonStyles}>
                            Low fees
